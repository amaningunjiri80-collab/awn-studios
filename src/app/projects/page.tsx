                ...
                <div className="image-zoom relative aspect-[16/10] bg-[#111] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                    ...
                    <div className="flex items-center gap-4 mt-2 text-sm text-white/50">
                      ...
                      {(project as { project_date?: string }).project_date && <span>Shot on {new Date((project as { project_date: string }).project_date).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}</span>}
                    </div>
